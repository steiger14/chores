defmodule SteigerWeb.SchoolControllerTest do
  ...
  describe "update school" do
    ...
    test "redirects when data is valid", %{conn: conn, school: school} do
      ...
      assert html_response(conn, 200) =~ "some updated season"
    end
